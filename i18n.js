...
const T = {
  es: {
    ...
    savedHint: "Guarda la configuración actual con un nombre en este navegador y recupérala cuando quieras. Se guarda solo en tu dispositivo (no se sube a ningún sitio); si borras los datos del navegador, se pierde.",
    savedNamePlaceholder: "Nombre (ej: cocina, persiana salón...)",
    savedSaveBtn: "Guardar la actual",
    savedLoadBtn: "Cargar",
    savedDeleteBtn: "Borrar",
    savedEmpty: "Todavía no has guardado ninguna configuración.",
    savedNeedName: "Escribe un nombre para guardar la configuración.",
    savedOk: 'Guardada como "%s".',
  ...
  en: {
    ...
    savedHint: "Save the current configuration with a name in this browser and reload it whenever you want. It's stored only on your device (nothing is uploaded); clearing your browser data will remove it.",
    savedNamePlaceholder: "Name (e.g. kitchen, living-room blind...)",
    savedSaveBtn: "Save current",
    savedLoadBtn: "Load",
    savedDeleteBtn: "Delete",
    savedEmpty: "You haven't saved any configuration yet.",
    savedNeedName: "Type a name to save the configuration.",
    savedOk: 'Saved as "%s".',
