...
const ACCESSORY_TYPE_INFO = {
  ...
  40: {
    keys: [
      { k: '"d"', d: "Tiempo que tarda la puerta en abrir del todo (segundos, por defecto 30)" },
      { k: '"0"', d: "Acción: cerrar una puerta abierta" },
      { k: '"1"', d: "Acción: abrir una puerta cerrada" },
      { k: '"2"', d: "Acción: cerrar una puerta que se está abriendo (invertir dirección)" },
      { k: '"3"', d: "Acción: abrir una puerta que se está cerrando (invertir dirección)" },
      { k: '"4"/"5"', d: "Acción al detectar puerta abierta / cerrada" },
      { k: '"6"/"7"', d: "Acción al detectar puerta abriéndose / cerrándose" },
      { k: '"8"', d: "Acción al desaparecer la obstrucción" },
      { k: '"f0"/"f1"', d: "Entrada: ordenar abrir / cerrar la puerta" },
      { k: '"f2"/"f3"', d: "Sensor: indica puerta ABIERTA / CERRADA (formato [[gpio, nivel]])" },
      { k: '"f4"/"f5"', d: "Sensor: indica puerta abriéndose / cerrándose" },
      { k: '"f6"/"f7"', d: "Sensor: sin obstrucción / con obstrucción" },
      { k: '"f8"', d: "Entrada: parada de emergencia" },
      { k: '"vs"', d: "Parada virtual: añade botón de parada en la app Casa (0 no, 1 sí)" },
    ],
  },
  45: {
    keys: [
      { k: '"o"/"c"', d: "Tiempo de apertura / cierre completo (segundos, por defecto 15; admite decimales)" },
      { k: '"w"', d: "Tipo: 0 persiana/enrollable, 1 ventana motorizada, 2 puerta motorizada" },
      { k: '"f"', d: "Corrección no lineal para el cálculo de posición (0-100 %, por defecto 0)" },
      { k: '"m"', d: "Margen de recalibración (0-100 %, por defecto 5): tiempo extra al abrir/cerrar del todo" },
      { k: '"vs"', d: "Parada virtual: para en vez de invertir dirección (0 no, 1 sí)" },
      { k: '"0"/"1"/"2"', d: "Acciones desde parada: cerrar / abrir / detener" },
      { k: '"3"/"4"', d: "Acción: cerrar mientras abre / abrir mientras cierra (invertir)" },
      { k: '"5"/"6"', d: "Acción: detener mientras cierra / mientras abre" },
      { k: '"7"/"8"', d: "Acción al quitar / detectar obstrucción" },
      { k: '"f0"/"f1"/"f2"', d: "Entradas: ordenar cerrar / abrir / detener" },
      { k: '"f3"/"f4"', d: "Entradas: alternar cerrar-stop / abrir-stop" },
      { k: '"f5"/"f6"', d: "Sensor: sin obstrucción / con obstrucción" },
      { k: '"f7"', d: "Entrada: ciclo alternar abrir-stop-cerrar" },
    ],
  },
  65: {
    keys: [
